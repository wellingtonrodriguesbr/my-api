...
import { CreateRefreskTokenDTO, IRefreshTokenRepository } from "./IRefreshTokenRepository";
...
export class RefreshTokenRepository implements IRefreshTokenRepository {
  ...
  async create({ expires, token, user_id, valid }: CreateRefreskTokenDTO): Promise<RefreshToken> {
